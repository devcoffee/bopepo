 ...
 * @version 0.2
 */
class CLCaixaEconomicaFederalSIGCBConvenio7 extends AbstractCLCaixaEconomicaFederal {
	 ...
	 */
	CLCaixaEconomicaFederalSIGCBConvenio7(Titulo titulo) {
		...
		String convenio = conta.getNumeroDaConta().getCodigoDaConta() + conta.getNumeroDaConta().getDigitoDaConta();
		this.add(new FixedField<Integer>(Integer.valueOf(convenio), 7, Fillers.ZERO_LEFT));
