...
/**
 * Parâmetros bancários específicos para o {@link BancosSuportados#BANCO_INTER}.
 *
 * @author Jose.Leite
 */
public enum ParametroBancoInter implements ParametroBancario<ParametroBancoInter> {
	OPERACAO;
}